...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="relative overflow-hidden group rounded-full bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-3 text-white font-medium transition-all duration-300 hover:shadow-[0_0_20px_rgba(16,185,129,0.5)] flex items-center justify-center"
    >
